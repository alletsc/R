...
#um corpus basicamente � um grande conjunto de texto estruturado
...
# Remover palavras especificadas do ingles
dfCorpus <- tm_map(dfCorpus, removeWords, stopwords('english'))

#varias versoes de uma palavras sao convertidas em uma unica instancia
