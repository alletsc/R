...
format(Sys.Date(), format = "Hoje e %A!")
...
data_de_hoje - my_time #tipos diferentes
...
wday(chegada, label = TRUE) #mostra nome dia da semana
class(chegada)
...
tm1.dechr
force_tz(tm1.lub, "Pacific/Auckland") #forçar time zone especifico
...
axis(side = 4)
mtext(side = 4, line = 2.5, col = "red", "dur")
mtext(side = 2, line = 2.5, col = "blue", "Efi")
