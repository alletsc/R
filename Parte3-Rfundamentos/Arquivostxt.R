...
df1
dim(df1)
# definindo titulo para as colunas
df1 <- read.table("pedidos.txt", header = TRUE, sep = ',', 
                  col.names = c("var1", "var2", "var3"))
df1
#indicando que nao queremos o registro de alguns dados
...
# Importando arquivo com read.csv()- reconhece virgula automaticamente
...
# Possivel importar arquivos da internet passando o link
